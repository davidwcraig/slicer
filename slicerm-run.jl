#=
Julia script to try out MCMC with a slice sampler from the command line
dwc 2018-09-05
=#

using LinearAlgebra # for julia 1.0

# here I set up the muli-d slicer
...
function g2(x,xa)
    # this will be the log density of a symmetric gaussian in 2-D
    return -0.5*dot(x,x)
end    

# make an MCMC chain that is 500 long and put it in res.
